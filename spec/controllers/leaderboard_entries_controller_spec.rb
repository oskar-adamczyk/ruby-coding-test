  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested leaderboard_entry" do
        leaderboard_entry = LeaderboardEntry.create! valid_attributes
        put :update, params: { id: leaderboard_entry.to_param, leaderboard_entry: new_attributes },
      ...
      it "redirects to the leaderboard_entry" do
        leaderboard_entry = LeaderboardEntry.create! valid_attributes
        put :update, params: { id: leaderboard_entry.to_param, leaderboard_entry: valid_attributes },
                     session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        leaderboard_entry = LeaderboardEntry.create! valid_attributes
        put :update, params: { id: leaderboard_entry.to_param, leaderboard_entry: invalid_attributes },
                     session: valid_session
        expect(response).to be_success
      end
    end
